...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "EidKit",
            url: "https://github.com/eidkit/eidkit-ios-releases/releases/download/v0.1.16/EidKit-0.1.16.xcframework.zip",
            checksum: "80d03bc3a32687b467959301bf6bcfe13ba1303eafa4602fb86e1f9754c8a014"
        ),
        .target(
            name: "EidKitRuntime",
            dependencies: [
